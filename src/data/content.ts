...
/*
  Il catalogo dei servizi è in src/data/services.ts.

  Ci è stato spostato quando è passato da sei voci a ventinove con categorie
  e pagine di dettaglio: teneva questo file su due schermate di scorrimento
  prima di arrivare a qualsiasi altra cosa. La regola resta la stessa —
  dati puri, nessun componente e nessun colore letterale.
*/
